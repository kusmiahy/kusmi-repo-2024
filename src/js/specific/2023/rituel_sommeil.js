...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.location.href.includes('com/fr') ? addPastille('.m-pdp__images-container', 'images/pdp/2023/rituel_sommeil/pastille_melisse_fr.svg?$staticlink$', 'Pastille Enrichi en extrait de mélisse') : addPastille('.m-pdp__images-container', 'images/pdp/2023/rituel_sommeil/pastille_melisse_en.svg?$staticlink$', 'Sticker enriched with lemon balm')
